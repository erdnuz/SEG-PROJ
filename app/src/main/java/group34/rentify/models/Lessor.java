package group34.rentify.models;
...
public class Lessor extends Account {
    ...
    // Constructor
    public Lessor(String email, String firstName, String lastName) {
     ...
     */
    public void createListing(String itemName, String description, Category category, double rentalFee) {
